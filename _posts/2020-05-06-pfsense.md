...
![wizard page](/images/pfsense/pfsense_01_wizard_01.PNG "first wizard page")
...
![wizard page](/images/pfsense/pfsense_01_wizard_02.PNG "second wizard page")
...
![Wi-Fi](/images/pfsense/wifi_01.PNG "wifi")
...
![WIFI](/images/pfsense/wifi_02.PNG)
...
![WIFI](/images/pfsense/wifi_03.PNG)
...
![ssh](/images/pfsense/pfsense_02_general_04.PNG)
...
![firewall](/images/pfsense/pfsense_02_general_05.PNG)
...
![ipv6](/images/pfsense/pfsense_02_general_06.PNG)
...
![hardware](/images/pfsense/pfsense_02_general_07.PNG)
...
![hiadaptive](/images/pfsense/pfsense_02_general_08.PNG)

My CPU supports AES-NI and I'll want that enabled for better VPN performance later.

![aesni](/images/pfsense/pfsense_02_general_09.PNG)
...
![notifications](/images/pfsense/pfsense_02_general_10.PNG)
...
![dhcp6](/images/pfsense/pfsense_02_general_12.PNG)

And then on each respective interface's page I can disable IPv6

![dhcp6](/images/pfsense/pfsense_02_general_11.PNG)
...
![ntp](/images/pfsense/pfsense_03_ntp_03.PNG)
...
![dhcp](/images/pfsense/pfsense_04_dhcp_01.PNG)
...
![dhcp](/images/pfsense/pfsense_04_dhcp_02.PNG)
...
![static mask](/images/pfsense/pfsense_04_dhcp_03.PNG)
...
![static mask](/images/pfsense/pfsense_04_dhcp_04.PNG)
...
![resolver](/images/pfsense/pfsense_04_dhcp_05.PNG)
...
![servers](/images/pfsense/pfsense_05_dns_01.PNG)
...
![pfblocker install](/images/pfsense/pfsense_06_pfblocker_01.PNG)

Head over to the settings page:

![pfblocker install](/images/pfsense/pfsense_06_pfblocker_02_install.PNG)

Then go through the wizard (this may come up automatically, it didn't for me):

![pfblocker install](/images/pfsense/pfsense_06_pfblocker_02_wizard.PNG)
...
![pfblocker install](/images/pfsense/pfsense_06_pfblocker_02_wizard2.PNG)

![pfblocker install](/images/pfsense/pfsense_06_pfblocker_02_wizard3.PNG)
...
![geoblock](/images/pfsense/pfsense_06_pfblocker_03.PNG)

Enable floating rules (see the video for a discussion on why)

![floating](/images/pfsense/pfsense_06_pfblocker_04.PNG)

Enable kill states

![kill](/images/pfsense/pfsense_06_pfblocker_05.PNG)
...
![geoip](/images/pfsense/pfsense_06_pfblocker_06.PNG)

And that's it! I can wait an hour or manually have it reload the settings:

![reload](/images/pfsense/pfsense_06_pfblocker_07.PNG)
